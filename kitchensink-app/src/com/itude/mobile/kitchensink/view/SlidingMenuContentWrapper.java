...
public class SlidingMenuContentWrapper implements MBContentViewWrapper
{
  ...
  public class SlidingMenuHomeButtonHandler implements HomeButtonHandler
  {
    ...
    public void handleButton()
    {
      ...
      if (_drawerLayout.isDrawerVisible(GravityCompat.START)) _drawerLayout.closeDrawer(GravityCompat.START);
